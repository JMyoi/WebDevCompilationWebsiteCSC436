...
function App() {
  const sites = [
    ...
    {
      id:2,
      title: "React Basics (CSC 436 Class Workspace)", 
      link: "https://github.com/diabeatz96/csc436ProjectWorkspace", 
      description: "This comprehensive course will take you from React beginner to confident developer. Each day builds upon the previous, with hands-on exercises and real-world examples. Learn React Fundementals, Props & Component Communication, Effects & Side Effects, and more.",
    },
    {
      id:3,
